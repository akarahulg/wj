...
\definecolor{TagColor}{HTML}{E53888} 
...
%%% MODIFIED: Helper command to print multiple tags
\newcommand{\@printtasktag}{%
    \ifUserProvidedTag
        \@for\CurrentTag:=\TaskTag\do{%
            \textcolor{TagColor}{\texttt{\space\#\CurrentTag}}%
        }%
    \fi
}

%%% MODIFIED: @createmaintask to handle multiple tags
\newcommand{\@createmaintask}[4][]{%
    ...
    \ifUserProvidedLabel
        ...
        %%% MODIFIED: Loop through tags and write one aux entry for each
        \ifUserProvidedTag
            \@for\CurrentTag:=\TaskTag\do{%
                \protected@write\@auxout{}{\string\addtasktotag{\CurrentTag}{\FullTaskLabel}}%
            }%
        \fi
    \fi
    \def\markerForToc{}
    ...
    \ifTaskIsDone
        ...
        \@printtaskmarker ~#4\@printtasktag
    \else\ifTaskIsIgnored 
        \textcolor{IconColor}{\faTimes}~\textcolor{TaskIgnore}{\textbf{Task \thetasknumber:}}%
        \ifUserProvidedLabel\textcolor{TaskLabel}{\texttt{\,[\FullTaskLabel]}}\fi
        \@printtaskmarker ~\textcolor{TaskIgnore}{\sout{#4}}\@printtasktag
    \else
        \ifTaskIsDoing
...
%%% MODIFIED: @createsubtask to handle multiple tags
\newcommand{\@createsubtask}[3][]{%
    ...
    \ifTaskIsDone
        ...
        \ifUserProvidedLabel\textcolor{TaskLabel}{\texttt{\,[\FullTaskLabel]}}\fi
        \@printtaskmarker ~#3\@printtasktag
    \else\ifTaskIsIgnored 
        \textcolor{IconColor}{\faTimes}~\textcolor{TaskIgnore}{\textbf{\thesubtasknumber:}}%
        \ifUserProvidedLabel\textcolor{TaskLabel}{\texttt{\,[\FullTaskLabel]}}\fi
        \@printtaskmarker ~\textcolor{TaskIgnore}{\sout{#3}}\@printtasktag
    \else
        \ifTaskIsDoing
            \colorbox{ActiveTaskBackground}{%
